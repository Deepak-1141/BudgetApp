...
var budgetController = (function () {
    ...
    return {
        ...
        deleteItem: function(type, id) {
            ...
            if (index !== -1) {
                data.allItems[type].splice(index, 1);  // remove element at index 3 and 1 means we are removing only one element
            }
   ...
   return {
    ...
    addListItem: function(obj, type) {
        ...
        clearFields: function() {
            ...
            fieldsArr = Array.prototype.slice.call(fields); // queryAll returns a list so array property like slice wont work but it workd by using prototype
...
var controller = (function(budgetCtrl,UICtrl) {
    ...
    var setupEvenetListeners = function () {
        ...
        document.addEventListener('keypress', function (event) {
            if(event.keyCode===13 || EventTarget.which === 13)
                CtrlAddItem();
